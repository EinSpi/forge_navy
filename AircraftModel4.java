...
public class AircraftModel4<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "aircraftmodel4"), "main");
	...
	public AircraftModel4(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition vertical = partdefinition.addOrReplaceChild("vertical", CubeListBuilder.create().texOffs(134, 191).addBox(-1.5F, -48.0F, -90.0F, 3.0F, 18.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		.texOffs(134, 182).addBox(-3.0F, -31.0F, 44.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
